...
//                if(!getText().toString().contains("MYR"))
//
//                s.append("MYR");
//
//            }
...
//            boolean isVisible = getText().toString().length() >= 1;
//            Log.i("William", "" + isVisible);
//            Log.i("William", "Text :: " + getText().toString());
        }
...
//        }
//        //Use the code sets the control left, top, right, and bottom Icon
//        setCompoundDrawables(leftDrawable, getCompoundDrawables()[1],
